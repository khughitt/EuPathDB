...
Because the eupathdb is constantly evolving, the get_eupathdb_pkgnames() function will use
the metadata generated in download_eupathdb_metadata() in order to provide a differently
