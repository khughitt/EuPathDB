...
write_eupathdb_metadata(all_metadata, bioc_version=bioc_version, eu_version=eu_version)
...
the variables bsgenome and organdb are of course, FALSE in this invocation.
...
if (isTRUE(organdb)) {
  ...
  save(list=c("organ_checked"), file="organismdbi_metadata.rda")
  organ_checked[[1]]
}
if (isTRUE(granges)) {
  grange_csv <- check_csv(file_type="GRanges", bioc_version=bioc_version, eu_version=eu_version)
