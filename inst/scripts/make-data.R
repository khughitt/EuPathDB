...
## entries in the csv.
if (isTRUE(bsgenome)) {
  bs_csv <- check_csv(file_type="BSgenome")
  bs_files <- check_files("BSgenome")
...
if (isTRUE(orgdb)) {
  org_csv <- check_csv(file_type="OrgDb")
  org_files <- check_files("OrgDb")
...
if (isTRUE(txdb)) {
  txdb_csv <- check_csv(file_type="TxDb")
  tx_files <- check_files("TxDb")
...
if (isTRUE(organdb)) {
  organ_csv <- check_csv(file_type="OrganismDbi")
  organ_files <- check_files("OrganismDbi")
...
if (isTRUE(granges)) {
  grange_csv <- check_csv(file_type="GRanges")
  grange_files <- check_files("GRanges")
