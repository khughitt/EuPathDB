...
## ----load, eval=FALSE----------------------------------------------------
#  library(org.Tcruzi.CL.Brener.Esmeraldo.like.v46.eg.db)
#  keytypes(org.Tcruzi.CL.Brener.Esmeraldo.like.v46.eg.db)
#  tc_annot <- load_orgdb_annotations("org.Tcruzi.CL.Brener.Esmeraldo.like.v46.eg.db", fields="all")
