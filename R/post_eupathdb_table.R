...
#' @export
<<<<<<< HEAD:R/post_eupath_table.R
post_eupath_table <- function(entry, tables = "GOTerms", table_name = NULL, minutes = 30) {
=======
post_eupathdb_table <- function(query_body, entry, table_name=NULL, minutes=30) {
>>>>>>> fd9c661 (Doing a bit of re-organizing):R/post_eupathdb_table.R
  if (is.null(entry)) {
