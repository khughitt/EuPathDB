...
post_eupath_pdb_table <- function(entry=NULL, workdir="EuPathDB", overwrite=FALSE) {
  if (is.null(entry)) {
  ...
  result <- post_eupath_table(query_body, entry, table_name="pdb")
